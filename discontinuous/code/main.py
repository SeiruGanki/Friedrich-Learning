...
if __name__ == '__main__':
    fspace = {
        ...
        'net_u':hp.choice('net_u', ['ResNet_Relu','ResNet_ST']),
        ...
        'optimizer_u':hp.choice('optimizer_u', ['Adam','Rmsprop']), # optimizer for slu net Adam/Rms
        'optimizer_v':hp.choice('optimizer_v', ['Adam','Rmsprop']), # optimizer for test net Adam/Rms
        }
